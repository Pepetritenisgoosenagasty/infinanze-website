import { Button, Grid, Image, List, ThemeIcon } from "@mantine/core";
...
const Header = () => {
  ...
  return (
    <div className="fixed top-0 z-40 w-[100%] header" >
      <div
        className={` h-[80px]   flex items-center justify-between px-[120px] sub-header ${
          show
            ? " bg-white text-[#000] border-b"
      ...
      >
        ...
        <div className="">
          <ul className="flex items-center space-x-8 z-40 lists">
            {data.map((item, index) => (
              <React.Fragment key={index}>
                <li
                  className={`text-[14px] cursor-pointer font-bold py-2 ${
                    ...
                    router.asPath === item.alias &&
                    "text-[#1974FB] border-b-2 border-[#1974FB]"
                  } `}
                  onClick={
                    item.path
        ...
        <div className={`${show ? "contact" : "nav-btn"} btn`}>
      ...
      {nav && (
        <div className="min-h-[400px] bg-white z-40 px-[120px] relative border-b">
          <div
            className="absolute top-6 right-[130px] cursor-pointer"
                  ...
                  <div className="py-8">
                    <div style={{ width: 350 }}>
                      ...
                      <p className="mt-6 text-sm">
                        Our team can help to develop and implement an effective
