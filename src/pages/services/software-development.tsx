      ...
      <main className={`min-h-full z-10 ${raleway.className}`}>
        <section className="w-full max-h-[900px] relative">
          ...
          <div className="absolute top-[45%] left-[50%] -translate-y-[50%] -translate-x-[50%] z-20 text-center">
            ...
            <Button px={4} py={8} sx={{width: '400px !important', height: 50, background: '#F4ECEC', color: '#1974FB'}} fz="lg" rightIcon={<BsArrowRight style={{marginLeft: 30}}/>}>Create a project with us today</Button>
            </div>
          </div>
        ...
        <section className={`pt-20 px-[50px] min-h-[200px] container mx-auto `}>
            <div className="text-center">
                <p className="font-[14px]">Utilize our extensive knowledge in consolidating app portfolios, modernizing outdated systems,<br /> and developing corporate software. By re-engineering solutions of various levels of complexity,<br /> we assist huge enterprises in becoming enduring successes on a worldwide scale.</p>
            </div>
        </section>
